...
export const ResponsiveNavbar = () => {
  ...
  useEffect(() => {
    setIsHome(location.pathname === '/'); // Verifica se está na homepage
  }, [location.pathname]);
  ...
  return (
    <nav className="w-screen flex items-center justify-between p-4 bg-orange-500 text-white fixed top-0 left-0 z-10 shadow-lg">
      ...
      >
        <svg width="82.8" height="40" viewBox="0 0 118 57" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect width="117.09" height="57" fill="white"/>
          </clipPath>
          </defs>
        </svg>
{/*<img src={logo} alt="Logo" className="h-10 w-auto" />  Ajuste a altura conforme necessário EU ALTEREI PRA SVG AFIM DE MELHORAR A QUALIDADE, POIS A IMAGEM EM PNG TAVA RUIM.*/}
    ...
    >
      Home 
      <span
        className={`absolute left-0 -bottom-1 w-full h-0.5 bg-white opacity-70 transition-transform duration-500 ease-in-out ${
